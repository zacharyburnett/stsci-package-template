# Running tests for {{ cookiecutter.project_name }}

`{{ cookiecutter.package_name }}` has several test suites to ensure that functionality remains consistent and does not break when code changes.
